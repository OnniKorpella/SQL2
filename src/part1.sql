...
CALL pr_import_data_from_csv('Peers',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/peers_date.csv',
    ';'
);

CALL pr_import_data_from_csv('Tasks',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/tasks_date.csv',
    ';'
);

CALL pr_import_data_from_csv('Checks',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/checks_date.csv',
    ';'
);

CALL pr_import_data_from_csv('P2P',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/p2p_date.csv',
    ';'
);

CALL pr_import_data_from_csv('Verter',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/verter_date.csv',
    ';'
);

CALL pr_import_data_from_csv('TransferredPoints',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/transferredpoints_date.csv',
    ';'
);

CALL pr_import_data_from_csv('Friends',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/friends_date.csv',
    ';'
);

CALL pr_import_data_from_csv('Recommendations',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/recommendations_date.csv',
    ';'
);

CALL pr_import_data_from_csv('XP',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/xp_date.csv',
    ';'
);

CALL pr_import_data_from_csv('TimeTracking',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/csv/timetracking_date.csv',
    ';'
);
...
CALL pr_export_data_from_csv('Peers',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/peers_date.csv',
    ';'
);

CALL pr_export_data_from_csv('Tasks',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/tasks_date.csv',
    ';'
);

CALL pr_export_data_from_csv('Checks',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/checks_date.csv',
    ';'
);

CALL pr_export_data_from_csv('P2P',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/p2p_date.csv',
    ';'
);

CALL pr_export_data_from_csv('Verter',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/verter_date.csv',
    ';'
);

CALL pr_export_data_from_csv('TransferredPoints',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/transferredpoints_date.csv',
    ';'
);

CALL pr_export_data_from_csv('Friends',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/friends_date.csv',
    ';'
);

CALL pr_export_data_from_csv('Recommendations',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/recommendations_date.csv',
    ';'
);

CALL pr_export_data_from_csv('XP',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/xp_date.csv',
    ';'
);

CALL pr_export_data_from_csv('TimeTracking',
    '/Volumes/ADD_A_USER/working_folder/Sql/SQL2/SQL2_Info21_v1.0-0-develop/src/export_csv/timetracking_date.csv',
    ';'
);
